...
"""
"""
Original codes from: https://github.com/travisbrady/word2phrase
For python 3 compatibility, I replaced a few lines.
Original lines remain with a # sign at the beginning of the lines.
Ahmet Aksoy - 20160715
"""
#from __future__ import division            # original
#from itertools import tee, izip_longest    # original
...
def pairwise(iterable):
    ...
    a, b = tee(iterable)
    next(b)
    #return izip_longest(a, b)      # original
...
def filter_vocab(vocab, min_count):
    ...
    """
    #return dict((k, v) for k, v in vocab.iteritems() if v >= min_count)    # original
...
def main():
    ...
    #train_file = (line.split() for line in file(options.train_file))   # original
